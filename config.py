...
SYMBOL = os.getenv("CNT_SYMBOL", "ETHUSDT")
...
SYMBOL_VALIDATION_LOG_FILE = "logs/symbol_validation.log"
SYMBOL_VALIDATION_REPORT_FILE = "data/symbol_validation_report.json"
